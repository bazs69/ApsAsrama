          ...
          {links.map((link) => {
            ...
            return (
              <Link
                key={link.id}
                href={link.href}
                className="group relative bg-white dark:bg-zinc-900/40 hover:bg-zinc-50 dark:hover:bg-zinc-800/80 border border-zinc-200/80 dark:border-zinc-800/80 rounded-2xl p-4 transition-all duration-200 text-left flex flex-col hover:-translate-y-1 hover:shadow-sm focus:outline-none focus:ring-2 focus:ring-primary-500 overflow-hidden"
              >
                ...
                <div className="relative z-10 mt-auto">
                  ...
                  <p className="text-[10px] text-zinc-500 dark:text-zinc-400 font-medium line-clamp-1">Akses cepat menu</p>
                </div>
              </Link>
            )
          })}
