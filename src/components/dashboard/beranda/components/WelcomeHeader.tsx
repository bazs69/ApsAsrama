      ...
      <div className="lg:col-span-8 relative overflow-hidden flex flex-col justify-center p-8 rounded-3xl bg-gradient-to-br from-primary-50/60 via-white to-white dark:from-primary-950/40 dark:via-zinc-950 dark:to-zinc-900/80 border border-primary-100/50 dark:border-zinc-800 shadow-xl shadow-zinc-200/40 dark:shadow-none transition-all duration-300 hover:shadow-2xl hover:shadow-primary-500/10 dark:hover:shadow-primary-500/5 group animate-in fade-in zoom-in-95 duration-500 h-full min-h-[140px]">
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center space-x-3 mt-4">
            <span className="bg-white/80 dark:bg-zinc-900/90 text-zinc-700 dark:text-zinc-300 text-[10px] font-bold px-3 py-1.5 rounded-full uppercase tracking-widest shadow-sm border border-zinc-200 dark:border-zinc-800 backdrop-blur-sm">
              {displayRole}
            </span>
            {motivation && (
